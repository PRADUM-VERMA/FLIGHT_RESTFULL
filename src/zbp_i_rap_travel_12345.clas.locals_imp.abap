...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
   " Read the travel status of the existing travels
    READ ENTITIES OF ziptravel_1234 IN LOCAL MODE
      ENTITY Travel
         ...
         IF has_before_image = abap_true.
           ...
           IF update_granted = abap_false.
             APPEND VALUE #( %tky        = travel-%tky
                             %msg        = NEW zcm_rap_p_1234( severity = if_abap_behv_message=>severity-error
                                                             textid   = zcm_rap_p_1234=>unauthorized )
                           ) TO reported-travel.
           ENDIF.
  ...
  METHOD acceptTravel.
   " Set the new overall status
    MODIFY ENTITIES OF ziptravel_1234 IN LOCAL MODE
      ENTITY Travel
         UPDATE
           FIELDS ( TravelStatus )
...
*      " Clear state messages that might exist
    ...
    DATA business_data TYPE TABLE OF zrap_12345z_travel_agency_es5.
...
**      IF travel-AgencyID IS INITIAL OR NOT line_exists( agencies_db[ agency_id = travel-AgencyID ] ).
      IF travel-AgencyID IS INITIAL OR NOT line_exists( business_data[ agencyid = travel-AgencyID ] ).
        ...
        APPEND VALUE #( %tky        = travel-%tky
                        %state_area = 'VALIDATE_AGENCY'
                        %msg        = NEW zcm_rap_p_1234(
                                          severity = if_abap_behv_message=>severity-error
                                          textid   = zcm_rap_p_1234=>agency_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-CustomerID IS INITIAL OR NOT line_exists( customers_db[ customer_id = travel-CustomerID ] ).
        ...
        APPEND VALUE #(  %tky        = travel-%tky
                         ...
                         %msg        = NEW zcm_rap_p_1234(
                                           severity   = if_abap_behv_message=>severity-error
                                           textid     = zcm_rap_p_1234=>customer_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-EndDate < travel-BeginDate.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_p_1234(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_p_1234=>date_interval
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date( ).
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_p_1234(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_p_1234=>begin_date_before_system_date
                                                 begindate = travel-BeginDate )
  ...
  AUTHORITY-CHECK OBJECT 'ZOPSTAT123'
      ID 'ZOPSTAT123' DUMMY
      ID 'ACTVT' FIELD '01'.
  ...
  METHOD is_delete_granted.
   IF has_before_image = abap_true.
      AUTHORITY-CHECK OBJECT 'ZOPSTAT123'
        ID 'ZOPSTAT123' FIELD overall_status
        ID 'ACTVT' FIELD '06'.
    ELSE.
      AUTHORITY-CHECK OBJECT 'ZOPSTAT123'
        ID 'ZOPSTAT123' DUMMY
